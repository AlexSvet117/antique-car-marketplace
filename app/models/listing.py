...
class Listing(db.Model):
    ...
    transportation_cost = mapped_column(Numeric(10,2), nullable=True)
    ...
    status = mapped_column(Enum ('active', 'pending', 'sold', 'inactive', name='status_enum'), default = "active", nullable=False)
    inspection = mapped_column(Enum ('inspected','as is', name='inspection_enum'), default="inspected", nullable=False)
